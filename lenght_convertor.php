<?php
    ...
    function lenghtConvertor(int $from, int $to, float $fromVal, $lengthUnits){  
        if(is_int($from) && is_int($to) && is_float($fromVal)){
        $difference = $from - $to;
        $result= $fromVal * pow(10, $difference);/* pow ile üs alıyoruz */
        $result = strval($fromVal).$lengthUnits[$from-1].'-->'.$result.$lengthUnits[$to-1];
...
<html>
    ...
    <main class="container">
        <form action="lenght_convertor.php" method="GET">
            <div class="row">
                <div class="col-md-5">
                    <!-- from section-->
                    <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="row">
                        <?php 
                            ...
                            <div class="col-md-12 m-2">
                                <p>'.lenghtConvertor($from, $to, $fromVal, $lengthUnits).'</p>
                            </div>
                            ';
                        ?>
                        <!--<div class="col-md-12 m-2">
